...
public class StartupActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Spinner device_spinner, smpl_rate_spinner, signal_time_spinner, signal_select_spinner;
    private Button start_btn;
    private EditText x_editText,y_editText,z_editText;
    private TextView label_text_v,sig_time_text_v,sig_sel_text_v;
        ...
        start_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startNewAct(device_spinner.getSelectedItem().toString(),Integer.parseInt(smpl_rate_spinner.getSelectedItem().toString()),
                        ...
                        Double.parseDouble(x_editText.getText().toString()), Double.parseDouble(y_editText.getText().toString()),
                        Double.parseDouble(z_editText.getText().toString()));
            }
        });
    ...
    public void startNewAct(String target,int smplRate, String signalTime,int signalSelection,double x, double y, double z) {
